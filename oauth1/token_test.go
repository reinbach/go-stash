...
func TestEncodeRequestToken(t *testing.T) {
	...
	expectedStr := "oauth_callback_confirmed=true&oauth_token=c0cf8793d39d46ab&oauth_token_secret=FMMj3w7plPEyhK8ZZ9lBsp"
...
func TestEncodeAccessToken(t *testing.T) {
	...
	tokenStr := token.Encode()
	expectedStr := "oauth_token=c0cf8793d39d46ab&oauth_token_secret=FMMj3w7plPEyhK8ZZ9lBsp&user=dr_van_nostrand"
	if tokenStr != expectedStr {
